        ...
        btnEntrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                auth.createUserWithEmailAndPassword(txtEmail.getText().toString(), txtSenha.getText().toString())
                    .addOnCompleteListener(UsarComoActivity.this, new OnCompleteListener<AuthResult>() {
                        @Override
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(UsarComoActivity.this, "Cadastrado com sucesso", Toast.LENGTH_SHORT).show();

                            } else {
                                Toast.makeText(UsarComoActivity.this, "Erro ao ser cadastrado", Toast.LENGTH_SHORT).show();
                            }
